...
const Widget = (props: AllWidgetProps<IMConfig>) => {
  ...
  useEffect(() => {
    ...
    const attach = () => {
      ...
      const sharedExpression = (custom.arcadeMode === 'custom' && custom.arcadeExpression && custom.arcadeExpression.trim())
      ...
      if (custom.activeSourceIndex != null) searchOptions.activeSourceIndex = custom.activeSourceIndex
